...
//  BotWid, BotLen, TWDif, TLDif, keyh, WSft, LSft  XSkew, YSkew, ZSkew, WEx, LEx, CapR0i, CapR0f, CapR1i, CapR1f, CapREx, StemEx
    ...
    [18.00,  18.00,   5.6, 	   5,  5.5,    0,   .0,     5,    -0,    -0,   2, 2.5,    .10,      2,     .10,      3,     2,       2], //Levee Steno R2/R4
    [18.00,  18.00,   5.6, 	   5,  5.1,    0,   .0,     0,    -0,    -0,   2, 2.5,    .10,      3,     .10,      3,     2,       2], //Levee Steno R3
    //Thumb
...
//FFwd1 FFwd2 FPit1 FPit2  DshDep DshHDif FArcIn FArcFn FArcEx     BFwd1 BFwd2 BPit1 BPit2  BArcIn BArcFn BArcEx FTani FTanf BTani BTanf TanEX PhiInit PhiFin
  //Column 0
  [ 5.4,    4.1,    7,  -60,      8,    2.2,   12,    17.5,   2,      6,  4.1,    2,   -55,   12,    15.5,   2,     4,  5.5,  4,  5.5,   2, 203, 210], //Chicago Steno R2/R4
//  [ 4.5,    4,    7,  -50,      7,    1.7,   11,    17,     2,      4.5,    4,    2,   -35,   11,    15,     2,     3,  4.5,    3,  4.5,   2, 203, 210], //Chicago Steno R2/R4
  [ 5.4,    4.1,    5,  -50,      8,    2.2,   12,    15.5,     2,    5.4,  4.1,    5,   -50,   12,    15.5,   2,     4.6,  5.6,  4.6,  5.6,   2, 200, 210], //Chicago Steno R3 flat
